...
def main():
    ...
    dataset_train = DatasetWeighted2(
        ...
        augmentation=alb.load("D:\\bakalarka\\to_black\\aug01.json"),
    ...
    model = torch.load("D:\\bakalarka\\to_black\\weights.pth")
    ...
    model.segmentation_head[2] = torch.nn.Softmax(dim=None)
    ...
    for i_epoch in range(1):
        ...
        if max_score < valid_logs['fscore']:
            ...
            torch.save(model, data_dir + '\\weights_black2545.pth')
            last_epoch = i_epoch
            print('Model saved!')
