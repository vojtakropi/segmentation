...
class ModelInput:
    ...
    def __init__(self, evaluate_only,
        ...
        self.augmentation_file_name = augmentation_file_name
    ...
    def init_base_dependent_paths(self, histology_segmentation_root_str):
        ...
        # find augmentations
        self.augmentation_file_path = self.histology_segmentation_root / 'augmentations' / (self.augmentation_file_name + '.json')
        # find classes
